...
const BLOG_CONFIG = {
    categories: {
        ...
        research: {
            name: 'Research',
            icon: 'fas fa-search',
            description: 'Technical research papers, studies, and experimental work'
        },
        projects: {
            name: 'Projects',
            icon: 'fas fa-project-diagram',
            description: 'Technical projects with documentation and details'
        }
...
async function discoverCategoryPosts(category) {
    ...
    for (const filename of files) {
        try {
            ...
            console.warn(`Could not load file: ${pathPrefix}/${filename}`, error);
        }
    }
